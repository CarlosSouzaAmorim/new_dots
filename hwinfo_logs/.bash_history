...
sudo pacman -Syu
sudo pacman -S --needed python git base-devel python-pipx avrdude avr-gcc avr-libc libusb
...
nano .bash_history 
exit
cd /home/carlos/.local/share/omarchy/
ls
cat boot.sh 
cd default/
ls
